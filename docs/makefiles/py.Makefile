...
STAGE_1_BUILD_ARGS ?= 
STAGE_1_DOCKERFILE ?= docker/Dockerfiles/[base-distributions]/programming-languages/python.Dockerfile

#### Stage N (Multistaged build - Add-on Dockerfiles)
STAGE_2_IMAGE_NAME ?= thanatisia/docker-ide
STAGE_2_IMAGE_TAG ?= python
...
CONTAINER_MOUNT_VOLUMES ?= \
						   -v "${PWD}/projects/python:/projects" \
