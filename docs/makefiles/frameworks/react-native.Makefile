...
STAGE_1_BUILD_ARGS ?= 
STAGE_1_DOCKERFILE ?= docker/Dockerfiles/[base-distributions]/frameworks/react-native.Dockerfile

#### Stage N (Multistaged build - Add-on Dockerfiles)
STAGE_2_IMAGE_NAME ?= thanatisia/docker-ide
STAGE_2_IMAGE_TAG ?= react-native
...
CONTAINER_IMAGE_TAG ?= react-native
